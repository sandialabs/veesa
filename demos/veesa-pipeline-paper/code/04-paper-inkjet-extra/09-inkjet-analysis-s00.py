...
#pickle.dump(cyan_smoothed, open(fp_res + "inkjet-s00-smoothed-cyan.pkl", "wb"))

# Align data
start_time = time.time()
cyan_aligned = fs.time_warping.fdawarp(cyan, spectra)
cyan_aligned.srsf_align(parallel=True, cores=ncores, center=True, omethod="DP")
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s00-aligned-cyan.pkl", "wb"))
pickle.dump(cyan_aligned, open(fp_res + "inkjet-s00-aligned-cyan.pkl", "wb"))
...
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s00-jfpca-cyan.pkl", "wb"))
pickle.dump(cyan_jfpca, open(fp_res + "inkjet-s00-jfpca-cyan.pkl", "wb"))

#### Analysis of Magenta ------------------------------------------------------

# # Smooth functions
# magenta_smoothed = fs.smooth_data(f=magenta, sparam=s)
# pickle.dump(magenta_smoothed, open(fp_res + "inkjet-s00-smoothed-magenta.pkl", "wb"))

# Align data
start_time = time.time()
magenta_aligned = fs.time_warping.fdawarp(magenta, spectra)
magenta_aligned.srsf_align(parallel=True, cores=ncores, center=True, omethod="DP")
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s00-aligned-magenta.pkl", "wb"))
pickle.dump(magenta_aligned, open(fp_res + "inkjet-s00-aligned-magenta.pkl", "wb"))
...
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s00-jfpca-magenta.pkl", "wb"))
pickle.dump(magenta_jfpca, open(fp_res + "inkjet-s00-jfpca-magenta.pkl", "wb"))

#### Analysis of Yellow --------------------------------------------------------

# # Smooth functions
# yellow_smoothed = fs.smooth_data(f=yellow, sparam=s)
# pickle.dump(yellow_smoothed, open(fp + "inkjet-s00-smoothed-yellow.pkl", "wb"))

# Align data
start_time = time.time()
yellow_aligned = fs.time_warping.fdawarp(yellow, spectra)
yellow_aligned.srsf_align(parallel=True, cores=ncores, center=True, omethod="DP")
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s00-aligned-yellow.pkl", "wb"))
pickle.dump(yellow_aligned, open(fp_res + "inkjet-s00-aligned-yellow.pkl", "wb"))
...
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s00-jfpca-yellow.pkl", "wb"))
pickle.dump(yellow_jfpca, open(fp_res + "inkjet-s00-jfpca-yellow.pkl", "wb"))
