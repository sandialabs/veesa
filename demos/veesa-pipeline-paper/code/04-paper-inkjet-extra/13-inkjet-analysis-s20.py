...
pickle.dump(execution_time, open(fp_res + "inkjet-time-s20-smoothed-cyan.pkl", "wb"))
pickle.dump(cyan_smoothed, open(fp_res + "inkjet-s20-smoothed-cyan.pkl", "wb"))
...
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s20-aligned-cyan.pkl", "wb"))
pickle.dump(cyan_aligned, open(fp_res + "inkjet-s20-aligned-cyan.pkl", "wb"))
...
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s20-jfpca-cyan.pkl", "wb"))
pickle.dump(cyan_jfpca, open(fp_res + "inkjet-s20-jfpca-cyan.pkl", "wb"))
...
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s20-smoothed-magenta.pkl", "wb"))
pickle.dump(magenta_smoothed, open(fp_res + "inkjet-s20-smoothed-magenta.pkl", "wb"))
...
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s20-aligned-magenta.pkl", "wb"))
pickle.dump(magenta_aligned, open(fp_res + "inkjet-s20-aligned-magenta.pkl", "wb"))
...
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s20-jfpca-magenta.pkl", "wb"))
pickle.dump(magenta_jfpca, open(fp_res + "inkjet-s20-jfpca-magenta.pkl", "wb"))
...
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s20-smoothed-yellow.pkl", "wb"))
pickle.dump(yellow_smoothed, open(fp_res + "inkjet-s20-smoothed-yellow.pkl", "wb"))
...
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s20-aligned-yellow.pkl", "wb"))
pickle.dump(yellow_aligned, open(fp_res + "inkjet-s20-aligned-yellow.pkl", "wb"))
...
end_time = time.time()
execution_time = end_time - start_time
pickle.dump(execution_time, open(fp_res + "inkjet-time-s20-jfpca-yellow.pkl", "wb"))
pickle.dump(yellow_jfpca, open(fp_res + "inkjet-s20-jfpca-yellow.pkl", "wb"))
