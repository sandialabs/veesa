...
#pickle.dump(cyan_smoothed, open("../data/inkjet-s00-smoothed-cyan.pkl", 'wb'))
...
pickle.dump(cyan_aligned, open("../data/inkjet-s00-aligned-cyan.pkl", 'wb'))
...
pickle.dump(cyan_jfpca, open("../data/inkjet-s00-jfpca-cyan.pkl", 'wb'))

#### Analysis of Magenta ------------------------------------------------------

# # Smooth functions
# magenta_smoothed = fs.smooth_data(f=magenta, sparam=s)
# pickle.dump(magenta_smoothed, open("../data/inkjet-s00-smoothed-magenta.pkl", 'wb'))
...
pickle.dump(magenta_aligned, open("../data/inkjet-s00-aligned-magenta.pkl", 'wb'))
...
pickle.dump(magenta_jfpca, open("../data/inkjet-s00-jfpca-magenta.pkl", 'wb'))

#### Analysis of Yellow --------------------------------------------------------

# # Smooth functions
# yellow_smoothed = fs.smooth_data(f=yellow, sparam=s)
# pickle.dump(yellow_smoothed, open("../data/inkjet-s00-smoothed-yellow.pkl", 'wb'))
...
pickle.dump(yellow_aligned, open("../data/inkjet-s00-aligned-yellow.pkl", 'wb'))
...
pickle.dump(yellow_jfpca, open("../data/inkjet-s00-jfpca-yellow.pkl", 'wb'))
